...
public class InitKyxlStuApplication {
    ...
    public static void onApplicationCreate(Application application) {
        String managerLocation = application.getExternalFilesDir("shadow") + "/sample-manager-kyxlstu.apk";

        //InitApplication中已经设置过了，这里如果再设置会报错
//        LoggerFactory.setILoggerFactory(new AndroidLoggerFactory());

        if (isProcess(application, ":plugin.kyxlstu")) {
